...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__dashboard__ = __webpack_require__(809);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ngx_translate_core__ = __webpack_require__(207);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__core_actions_user_actions__ = __webpack_require__(211);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__core_actions_takings_actions__ = __webpack_require__(212);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__core_actions_pending_actions__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__core_actions_offer_actions__ = __webpack_require__(93);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__core_actions_transaction_actions__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ngrx_store__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__core_providers_initializer_initializer__ = __webpack_require__(213);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DashboardPage = (function () {
    function DashboardPage(store, initializer) {
        this.store = store;
        this.initializer = initializer;
    }
    DashboardPage.prototype.ngOnInit = function () {
        if (this.initializer.getUserInfo()) {
            this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_1__core_actions_user_actions__["c" /* FetchUserSucc */](this.initializer.getUserInfo()));
        }
    };
    DashboardPage.prototype.ionViewDidLoad = function () {
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_2__core_actions_takings_actions__["c" /* FetchTakings */]());
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_4__core_actions_offer_actions__["h" /* FetchOffers */]());
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_3__core_actions_pending_actions__["l" /* FetchPendings */](null));
        this.store.dispatch(new __WEBPACK_IMPORTED_MODULE_5__core_actions_transaction_actions__["d" /* FetchTransactions */](null));
    };
    DashboardPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: "page-dashboard",template:/*ion-inline-start:"/Users/radoslawwarisch/WebstormProjects/yummyPlaceFront/src/pages/dashboard/dashboard.html"*/'<ion-header>\n  <ion-navbar hideBackButton>\n    <button \n      class="menu__button"\n      ion-button \n      menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>\n      <img \n        class="header__logo"\n        src="assets/icon/yummy-logo.png" />\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <div \n    class="content">\n    <summary-container>\n    </summary-container>\n    <pending-container>\n    </pending-container>\n    <offers-container>\n    </offers-container>\n    <transactions-container>\n    </transactions-container>\n  </div>\n</ion-content>\n'/*ion-inline-end:"/Users/radoslawwarisch/WebstormProjects/yummyPlaceFront/src/pages/dashboard/dashboard.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_6__ngrx_store__["b" /* Store */],
            __WEBPACK_IMPORTED_MODULE_7__core_providers_initializer_initializer__["a" /* Initializer */]])
    ], DashboardPage);
